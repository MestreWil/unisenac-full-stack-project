      ...
      <div id='content'>
        <div id='album-page-details'>
          ...
          <div id='album-page-info'>
            ...
            <a id='yt-link'href={`${album.album_link}`}>
              <svg id='youtube' xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="white" class="bi bi-youtube" viewBox="0 0 16 16">
        ...
        <div id='reviews'>
          ...
          <div id='reviews-list'>
            ...
            <p><strong>User1:</strong> Great album!</p>
            <p><strong>User2:</strong> Really enjoyed it!</p>
          </div>
        </div>
      </div>
    </div>
